#!/usr/bin/env python3
"""Safe end-to-end-ish gateway dry run.

This script validates SaaS connectivity, static IP, live-arm state, Angel login,
market-data access, and the protected-limit price calculation WITHOUT calling
...
from okai_local_gateway import (
    AngelSession,
    SaaSClient,
    load_config,
)
