...
def _patch_captured_single_index_backtest():
    ...
    try:
        ...
        if any(marker not in changed for marker in required):
        ...
        try:
            ...
            pass
        return True, "OK_BALANCED_POINT_PATH_AND_NO_FOLLOW_V5"
    except Exception as exc:
        return False, f"{exc.__class__.__name__}:{str(exc)[:180]}"


def apply_structural_exit_v2_patch():
    # Preserve the historical import/function name used by main.py.
