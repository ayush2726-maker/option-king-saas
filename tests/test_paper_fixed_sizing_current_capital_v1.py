...
def test_profit_after_reset_increases_next_paper_sizing_base():
    c=_conn();_closed(c,5000,"2026-09-02 10:00:00");s={"trading_mode":"paper","paper_capital":20000,"paper_capital_reset_at":"2026-09-02 09:00:00"};assert _configured_paper_sizing_base(c,1,s)==25000;assert build_authoritative_ledger(c,1,s)["current_capital"]==25000;c.close()
...
def test_runtime_quantity_uses_cycle_equity():assert _runtime_capital_size(20000,1,90,65,[],None)["qty"]==65 and _runtime_capital_size(25000,1,90,65,[],None)["qty"]==130
